...
class NewsAdapter(val dataSource: List<ItemsItem>, private val click:(Fields?)->Unit) : RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
           with(dataSource[position].fields)
           {
               ...
               holder.item.setOnClickListener { click.invoke(this) }
           }
    }
